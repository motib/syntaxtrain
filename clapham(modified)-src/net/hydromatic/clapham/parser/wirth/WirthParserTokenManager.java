/* Generated By:JavaCC: Do not edit this line. WirthParserTokenManager.java */
package net.hydromatic.clapham.parser.wirth;
import java.util.*;
import net.hydromatic.clapham.parser.*;

/** Token Manager. */
public class WirthParserTokenManager implements WirthParserConstants
{
...
"\56", "\75", "\174", "\42", null, null, null, null, null, };
...
/** Constructor. */
public WirthParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
