...
public class Chart {
    ...
    public static final Color defaultCharColor			= Color.BLACK;
    ...
    public final int symbolGapWidth = 5;
    ...
    public Chart(Grammar grammar, Graphics2D graphics) {
