/*
// $Id: Grammar.java 3 2009-05-11 08:11:57Z jhyde $
...
*
* @author jhyde
* @version $Id: Grammar.java 3 2009-05-11 08:11:57Z jhyde $
* @since Aug 26, 2008
*/
public class Grammar {
            ...
            if (i.typ == NodeType.WRAP) {
                ...
                if (parent == null) {
                    ...
                    if (n == i) {
                        ...
                        if (i.up || i.next == null) {
                            Node eps = new Node(this, NodeType.EPS, null, n.lineToColor, n.nodeColor, n.nodeFont);
                            parent.sub = eps;
                            eps.up = i.up;
                            eps.next = i.next;
                            n = eps;
    ...
    void removeRedundancy(Node n, Node parent, Symbol s) {
        ...
        while (n != null && samelevel) {
            if (n.typ == NodeType.ALT) {
                ...
                if (containsIter) {
                    Node iter = new Node(this, NodeType.ITER, n.sub, n.lineToColor, n.nodeColor, n.nodeFont);
                    iter.next = n.next;
                    if (n == begin) {
                        if (parent == null) {
                            s.graph.l = iter;
    ...
    public void checkSubAlts(Node alt)	{
        ...
        Node eps = new Node(this, NodeType.EPS, null, alt.lineToColor, alt.nodeColor, alt.nodeFont);
        eps.next = alt.sub;
        alt.sub = eps;
        Node i = alt.sub;
        boolean samelevel = true;
                ...
                while (j != i && !matchFound) {
                    ...
                    while (k != null && samelevel2 && !matchFound) {
                        if (deepCompare(j, k, true)) {
                            ...
                            Node re = new Node(this, NodeType.RERUN, k, i.lineToColor, i.nodeColor, i.nodeFont);
                            if (j == n) {
